...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze = ImageIO.read(getClass().getResource("SpoopyMaze.jpg"));
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("roblox-death-sound-effect.wav"));
	...
	private void scare2() {
		...
		//10. Use the code below to load your sound.  Change the file name to match the name of your sound file.  
		AudioClip sound2 = JApplet.newAudioClip(getClass().getResource("tim_and_eric_it_s_free_real_estate.wav"));
